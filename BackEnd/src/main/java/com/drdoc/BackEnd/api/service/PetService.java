...
public interface PetService {
	Pet registerPet(String userId, PetRegisterRequestDto petRegisterRequestDto);
	Pet modifyPet(String userId, int petId, PetModifyRequestDto petModifyRequestDto);

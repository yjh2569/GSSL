...
public interface CommentService {
	Comment writeComment(String memberId, CommentWriteRequestDto requestDto);
	Comment modifyComment(String memberId, int commentId, CommentModifyRequestDto requestDto);
